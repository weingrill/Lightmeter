...
class Lightmeter:
    ...
    def _init_device():
        ...
        endpoint_out = usb.util.find_descriptor(
            ...
            custom_match=lambda cm: \
                usb.util.endpoint_direction(usb_exception.bEndpointAddress) == usb.util.ENDPOINT_OUT)

        endpoint_in = usb.util.find_descriptor(
            intf,
            # match the first IN endpoint
            custom_match=lambda cm: \
                usb.util.endpoint_direction(usb_exception.bEndpointAddress) == usb.util.ENDPOINT_IN)
